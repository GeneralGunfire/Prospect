    ...
    <>
      <motion.nav 
        ...
        className={cn(
          ...
          isScrolled ? "bg-soft-black/90 backdrop-blur-xl shadow-lg py-3" : "bg-transparent py-5"
        )}
      >
        <div className="flex justify-between items-center px-4 md:px-8 w-full max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="p-2 rounded-full transition-colors hover:bg-white/10 text-slate-400 hover:text-white"
            >
            ...
            <Link 
              to="/auth" 
              className="hidden lg:block px-8 py-2.5 bg-blue-600 text-white rounded-full font-bold text-[11px] uppercase tracking-widest hover:bg-blue-500 transition-all active:scale-95 shadow-lg shadow-blue-600/20"
            >
              Get Started
            </Link>
          </div>
        ...
        {isDrawerOpen && (
          <>
            <motion.div 
              ...
              exit={{ opacity: 0 }}
              onClick={toggleDrawer}
              className="fixed inset-0 bg-soft-black/60 z-[55] backdrop-blur-md"
            />
            <motion.div 
              initial={{ x: "-100%" }}
              animate={{ x: 0 }}
              ...
              className="fixed inset-y-0 left-0 z-[60] w-[85%] max-w-sm bg-soft-black shadow-2xl border-r border-white/10"
            >
              ...
              <div className="flex flex-col py-4 overflow-y-auto max-h-[calc(100vh-80px)]">
                {navLinks.map((link) => (
                  <button 
                    key={link.name}
                    onClick={() => scrollToSection(link.path)}
                    className="flex items-center justify-between px-8 py-5 transition-all text-xs font-bold uppercase tracking-widest text-white/70 hover:text-white hover:bg-white/5 text-left border-b border-white/5 last:border-0"
                  >
                    {link.name}
                ...
                {!isAuthenticated && (
                  <button 
                    onClick={handleGuest}
                    className="flex items-center justify-between px-8 py-5 transition-all text-xs font-bold uppercase tracking-widest text-blue-400 hover:bg-blue-400/5 text-left"
                  >
                    Continue as Guest
                    <User size={16} />
                  </button>
                  ...
                  {isAuthenticated ? (
                    <>
                      <Link 
                        ...
                        className="flex items-center justify-center w-full py-4 text-xs font-bold uppercase tracking-widest text-white border border-white/20 rounded-xl hover:bg-white/5 transition-all"
                      >
                        Dashboard
                      </Link>
                      <button 
                        ...
                        className="w-full py-4 text-xs font-bold uppercase tracking-widest text-white bg-red-600 rounded-xl shadow-lg shadow-red-600/20 active:scale-[0.98] transition-all"
                      >
                        Logout
                      </button>
                    </>
                    ...
                    <>
                      ...
                      <Link 
                        ...
                        state={{ isLogin: false }}
                        onClick={() => setIsDrawerOpen(false)}
                        className="flex items-center justify-center w-full py-4 text-xs font-bold uppercase tracking-widest text-white bg-blue-600 rounded-xl shadow-lg shadow-blue-600/20 active:scale-[0.98] transition-all"
                      >
                        Sign Up
                      </Link>
                    </>
...
const Hero = () => (
  <section id="home" className="relative pt-24 pb-32 md:pt-48 md:pb-64 overflow-hidden bg-soft-black">
    ...
    <motion.div 
      ...
      className="absolute inset-0 bg-gradient-to-b from-blue-600/20 via-blue-900/10 to-transparent" 
    />
      ...
      <div className="flex flex-col items-center text-center">
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-2.5 py-1.5 px-4 rounded-full bg-white/5 border border-white/10 text-blue-400 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] mb-8 md:mb-10 backdrop-blur-sm"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/60 leading-[1.1] mb-8 md:mb-12 tracking-tight uppercase"
          >
          ...
          <motion.p 
            ...
            className="text-base md:text-xl text-slate-400 mb-10 md:mb-16 leading-relaxed max-w-2xl mx-auto font-medium"
          >
          ...
          >
            <Link to="/auth" className="w-full sm:w-auto px-12 py-4 bg-blue-600 text-white font-bold rounded-full shadow-2xl shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-1 active:scale-95 transition-all uppercase tracking-[0.2em] text-[10px] md:text-xs text-center">
              Start Your Journey
            </Link>
            <button className="flex items-center gap-4 text-white font-bold uppercase tracking-[0.2em] text-[10px] md:text-xs group">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-blue-600 transition-all shadow-xl">
...
const PlatformFeatures = () => (
  <section id="platform-features" className="relative py-24 md:py-40 bg-slate-900 overflow-hidden">
    <div className="absolute inset-0 grid-bg opacity-10" />
    <div className="absolute inset-0 noise-bg" />
    <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
      <div className="text-center max-w-4xl mx-auto">
        <motion.h2 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-3xl md:text-6xl font-black text-white mb-8 tracking-tighter uppercase font-headline"
        >
        ...
        <motion.p 
          ...
          className="text-base md:text-2xl text-slate-400 mb-16 md:mb-24 leading-relaxed font-medium"
        >
        ...
        >
          <Link to="/auth" className="px-12 py-5 bg-blue-600 text-white font-bold rounded-full hover:bg-blue-700 transition-all uppercase tracking-[0.2em] text-xs shadow-2xl shadow-blue-600/20">
            Start Learning Now
          </Link>
        </motion.div>
      </div>
...
const StatItem = ({ number, label }: { number: string, label: string }) => (
  <div className="text-center">
    <div className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-1 md:mb-2 tracking-tight">{number}</div>
    <div className="text-[9px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">{label}</div>
  </div>
);
