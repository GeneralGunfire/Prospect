...
export const careers: Career[] = [
  ...
  },
  {
    ...
    category: 'Business',
    riasec: ['E', 'A', 'S'],
    description: 'Organize and operate a business or businesses, taking on greater than normal financial risks in order to do so.',
    salary: 'Variable',
    growth: 'High',
  ...
  },
  {
    ...
    category: 'Technology',
    riasec: ['I', 'C', 'E'],
    description: 'Analyze and interpret complex digital data, such as usage statistics of a website, especially in order to assist a business in its decision-making.',
    salary: 'R500k - R1.4m',
    growth: 'Very High',
