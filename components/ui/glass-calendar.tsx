    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-[#1A3E6F]/90 backdrop-blur-xl border border-white/10",
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-1 rounded-lg bg-black/20 p-1">
            <button className="rounded-md bg-white px-4 py-1 text-xs font-bold text-slate-800 shadow-md">
              Weekly
            </button>
              ...
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    {
                      "bg-gradient-to-br from-[#176293] to-[#3B5A7F] text-white shadow-lg": day.isSelected,
