      ...
      <nav className={cn(
        ...
        <div className="flex justify-between items-center px-6 md:px-12 w-full max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <Link to="/signup" className="px-8 py-2.5 bg-blue-600 text-white font-bold text-[11px] uppercase tracking-widest rounded-full hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20">
              Get Started
            </Link>
          </div>
