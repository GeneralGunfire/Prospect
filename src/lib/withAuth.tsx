...
export type AppPage = 'home' | 'auth' | 'dashboard' | 'quiz' | 'subject-selector' | 'library' | 'careers' | 'bursaries' | 'bursary' | 'map' | 'tvet' | 'tvet-careers' | 'tvet-colleges' | 'tvet-funding' | 'tvet-requirements' | 'calendar' | 'school-assist' | 'school-assist-chat' | 'impact-auth' | 'learning-algebra-g10-t1-linear-equations' | 'community-impact' | 'pothole-map' | 'flag-pothole' | 'my-pothole-contributions' | 'water-dashboard' | 'tax-budget' | 'cost-of-living' | 'civics' | 'demo-learning' | 'disadvantaged-guide' | 'news' | 'news-auth';
