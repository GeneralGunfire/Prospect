...
const FEATURES = [
  { icon: <Newspaper className="w-4 h-4 text-blue-600" />, text: 'SA News — curated daily, no sensitive content' },
  { icon: <Calculator className="w-4 h-4 text-blue-600" />, text: 'Tax & Budget — 2026 PAYE calculator' },
  { icon: <MapPin className="w-4 h-4 text-blue-600" />, text: 'Cost of Living — by province' },
  { icon: <Building2 className="w-4 h-4 text-blue-600" />, text: 'Civics — government forms & rights' },
];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 prospect-auth-bg relative overflow-hidden">
      ...
      <button
        ...
        className="absolute top-6 left-6 flex items-center gap-1.5 text-sm text-gray-500 hover:text-slate-900 transition-colors z-10"
      >
        <ArrowLeft size={16} />
        Back to home
      </button>
