      ...
      <div className="pt-24 pb-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 uppercase tracking-tight" style={{ color: '#1B5E20' }}>
            Matric <span style={{ color: '#64748b' }}>Requirements</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.entries(tradeRequirements).map(([trade, reqs], idx) => (
              <motion.div
                ...
                className="bg-white border-2 rounded-xl p-6 cursor-pointer hover:shadow-lg transition-all"
                style={{
                  borderColor: selectedTrade === trade ? '#1B5E20' : '#e2e8f0',
                  backgroundColor: selectedTrade === trade ? '#1B5E20' + '05' : 'white',
                }}
              >
                <h3 className="font-bold text-lg mb-4" style={{ color: '#1B5E20' }}>
                  {trade}
                </h3>
                  ...
                  <ul className="space-y-1">
                    {reqs.required.map((subj) => (
                      <li key={subj} className="flex gap-2 text-sm">
                        ...
                        <span style={{ color: '#475569' }}>{subj}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="mb-4 pb-4 border-t border-slate-200">
                  ...
                  <ul className="space-y-1">
                    {reqs.recommended.map((subj) => (
                      <li key={subj} className="flex gap-2 text-sm">
                        <span className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: '#F9A825' }}>○</span>
                        <span style={{ color: '#475569' }}>{subj}</span>
                      </li>
                    ))}
                  </ul>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} className="bg-green-50 rounded-xl p-8 border-l-4 border-green-600">
              <h3 className="font-bold text-2xl mb-4 flex items-center gap-2" style={{ color: '#1B5E20' }}>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white border-2 rounded-xl p-8" style={{ borderColor: '#1B5E20' }}>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              >
                <h3 className="font-bold text-lg mb-6" style={{ color: '#1B5E20' }}>
                  {item.title}
                </h3>
                <ul className="space-y-3">
                  {item.actions.map((action, aidx) => (
                    <li key={aidx} className="flex gap-3">
                      <CheckCircle className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#1B5E20' }} />
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-[#1B5E20] to-[#2D7F2E] rounded-xl p-8 text-white text-center">
