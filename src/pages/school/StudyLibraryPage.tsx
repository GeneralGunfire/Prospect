              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <div className="space-y-2">
                      <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400 mb-2">While you wait</p>
                      <button
                      ...
                      >
                        <div>
                          <p className="text-[14px] font-bold text-slate-900">Ask School Assist</p>
                          <p className="text-[11px] text-slate-400 mt-0.5">Get AI-powered help with this topic</p>
                        </div>
